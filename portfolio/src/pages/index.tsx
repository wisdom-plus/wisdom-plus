  ...
  return (
    <MainHead>
      <div className='p-4 md:p-12 text-center lg:text-left'>
        <div className='block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-conver bg-center' />
        ...
        <p className='pt-8 text-sm'>Failure is success if we learn from it.</p>
